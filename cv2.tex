...
\section{PROJECTS}
  ...
  \begin{tabbing}
   ...
   \hspace{2.3in}\= \hspace{2.6in}\= \kill % set up two tab positions
    ...
    {\bf Number of problems solved independently on Project Euler: 19/416}
  \end{tabbing}
